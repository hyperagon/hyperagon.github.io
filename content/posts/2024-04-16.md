...
+++
It seems that [Darknet](https://pjreddie.com/darknet/yolo/) was only using the **CPU**.
...
Nevermind, it still created `6 permanent CPU threads`, which makes me think that it only used **CPU**s.
