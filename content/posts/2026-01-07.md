...
```
Do not use classes for this, use Javascript objects for the Instrument.
```

Ok I got it working by forcinhg the AudioContext to regenerate with:
```
...
Anyway you can also get it and use locally [from here](https://github.com/hyperagon/Hexano/releases).
