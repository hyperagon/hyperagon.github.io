...
It's funny how they (LLMs) thought that they could tile Hexagons with the pointy-end sideways (⬣) next to each other.

Inspired by [this application](https://github.com/lrq3000/hexiano).

[Made a video](https://www.youtube.com/watch?v=-gKIUTGsfeE) about it showing how limited LLMs are, despite being eager to screw up.

Check out [Hexano 3](https://hyperagon.github.io/projects/hexano35/) to see what I was looking for, note that I added several things beyond [Hexano 1](https://hyperagon.github.io/projects/hexano15/).
