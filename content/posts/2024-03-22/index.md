...
I tried to include a labels.txt and referencing it with `labels = labels.txt` but still got warnings that it can't be found in images/*.txt... But it does look like it's not stopping.
