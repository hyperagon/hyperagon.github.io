...
+++
I didn't miss this one, it was just harder to setup than *2009scape* since its instructions relied on [IntelliJ](https://www.jetbrains.com/idea/) instead of plain *Command Line/Terminal*. I got it working and made a [pull request with the new file](https://github.com/hyperagon/2006Scape) but you can just use the [source](https://github.com/2006-Scape/2006Scape).
