...
I see, after re-reading and some searching I got it, only the server spawns and adds/removes players, I exagerated, both the **MultiplayerSpaner** and **MultiplayerSynchronizer** handle the rest so I have to get out of their way instead of re-doing what they do.
