...
The problem is the Graphics with many cards stuck at 9GB VRAM. If I don't care about Games and waant a capable computer for Machine Learning/Artificial Intelligence then I need more VRAM and all consumer crards are ignoring that niche. Perhaps it is just hard to meet? I think that Desktops can do just fine so why not?
