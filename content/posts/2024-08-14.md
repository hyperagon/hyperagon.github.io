...
#### For small ship slots (with an airplane) you can use docks or bays (atention: You need to select them with 1-9 keys*)
...
## [Add cargo to ship](https://naev.org/api/modules/pilot.html#cargoAdd)
