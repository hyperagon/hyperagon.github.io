...
### [Set Armor and Shield (Percentage)](https://naev.org/api/modules/pilot.html#%20setHealth)
...
## [Kill (With great Power comes Responsibility)](https://naev.org/api/modules/pilot.html#kill)

`player.pilot():target():kill()`

## [Board](https://naev.org/api/modules/pilot.html#board)

`player.pilot():target():board()`
...
## [Add to Cargo](https://naev.org/api/modules/pilot.html#cargoAdd)

`player.pilot():cargoAdd("Food", 20)`
