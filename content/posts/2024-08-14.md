...
### Especially useful to visit Pirate Systems (**!!** or ***** means that you can't land there)

`player.teleport("Quorel")`1
...
#### For bay slots (with an airplane) you can use docks or bays (hold the **6** key)
