...
+++
Unfortunately some of the times it does not work, and it's no wonder since we're just checkkining if the random results that we got performs well. It's a brute-force method.
