...
Apparently [minifying it myself](https://justbuildthings.com/code-minifier) stops [HUGO](https://gohugo.io/) from using its excessive minifier (which changes variable names).
