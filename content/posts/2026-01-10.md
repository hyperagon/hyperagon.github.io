+++
title = "Minification problems"
summary = "How annoying."
date = 2026-01-10T08:10:34+01:00
draft = false
tags = ['new year', 'hugo', 'hexano']
+++
[HUGO](https://gohugo.io/) reports no errors yet doesn't work now?

This post showed up fast yet the new Hexano 6.8 does not.
...
You can also download it and use locally [from here](https://github.com/hyperagon/Hexano/releases).
...
Apparently [minifying it myself](https://justbuildthings.com/code-minifier](https://bug0.com/tools/html-minifier) stops [HUGO](https://gohugo.io/) from using its excessive minifier (which changes variable names).
