...
draft = false
tags = ['new year', 'minification', 'hugo', 'hexano']
+++
...
Apparently [minifying it myself](https://bug0.com/tools/html-minifier) stops [HUGO](https://gohugo.io/) from using its excessive minifier (which changes variable names).
