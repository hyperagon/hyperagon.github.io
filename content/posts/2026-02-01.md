...
Yep, as expected. they all required clicking to draw... aome also used [Tailwind CSS](https://tailwindcss.com/) since I didn't specify that it should not have dependencies, it was just implied when asked for vanilla HTML/JS/CSS.
