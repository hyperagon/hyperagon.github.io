...
+++
I asked an LLM to make a prompt for [Slidus](https://hyperagon.github.io/projects/slidius17/) which it failed at first so I wonder if LLMs will actually be able to do this in 1 go?
...
Some also used [Tailwind CSS](https://tailwindcss.com/) since it didn't specify that it should not have dependencies, it was just implied when asked for vanilla HTML/JS/CSS.

[Made a video about this, you can't tell when I'm clicking though]([https://www.youtube.com/@hyperag-on](https://www.youtube.com/watch?v=vIb5ueLhttE)).
