...
+++
I asked am LLM to make a prompt for Slidus which it failed at first so I wonder if LLMs will actually be able to do this in 1 go.

Here's the generated prompt, note how it explicitly says that it should not require a mouse-press:
```
