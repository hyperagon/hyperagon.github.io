...
If you're using Windows you may find [the Bobafett Hero Editor](https://github.com/iccugs/bobafett_compiled_with_cheat_table) useful as well as other tools by [Diasurgical](https://github.com/diasurgical).
