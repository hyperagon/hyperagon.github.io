...
PS: If you'd rather you can also use [AwayFL](https://awayfl.org/) directly by running `python -m http.server` on its folder and opening `0.0.0.0:8000/example` on a browser.
